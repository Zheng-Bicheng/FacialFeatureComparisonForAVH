...
## 3.1 订阅使用 Arm 虚拟硬件镜像的百度智能云云服务器 BCC 实例
...
请根据自身是否为**新用户**的情况，二选一完成 1.2 章节。若**未购买过百度智能云的任何一款云服务器**产品，包括：从未注册过百度智能云账号的用户、以及已注册过百度智能云账号但未有发生过购买行为的用户，即为**新用户**，可享受优惠购买价格。

## 3.2 （新用户）购买使用 Arm 虚拟硬件镜像的百度智能云云服务器 BCC 实例
...
## 3.3 （非新用户）购买使用 Arm 虚拟硬件镜像的百度智能云云服务器 BCC 实例

### 3.3.1 订阅百度智能云云市场 Arm 虚拟硬件镜像
...
## 3.4 查看已购买的使用 Arm 虚拟硬件镜像的百度智能云云服务器 BCC 实例
...
## 3.5 登录使用 Arm 虚拟硬件镜像的百度智能云云服务器 BCC 实例
